document.addEventListener('DOMContentLoaded', function() {
  ...
  // Check for URL hash on page load to auto-open a project
  const checkHashAndOpenProject = () => {
    if (window.location.hash) {
      ...
      if (targetProject && targetProject.classList.contains('project')) {
        // Wait a tiny bit for page to fully render
        setTimeout(() => {
  ...
  // Check for hash and open project if needed
  checkHashAndOpenProject();
});